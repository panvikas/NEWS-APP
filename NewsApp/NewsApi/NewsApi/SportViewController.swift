...
extension SportViewController: UITableViewDataSource, UITableViewDelegate
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = sportTable.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! MyTableViewCell
        ...
        if articlesList[indexPath.row].urlToImage != nil
        {
            ...
            cell.myImageView.sportImages(from: url!)
